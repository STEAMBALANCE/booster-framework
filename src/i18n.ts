// Public API for framework code: import { LL } from './i18n';
//
...
//
// Our dict is nested (`framework.window.close_aria_label`), so swapping
...
// tightened.
//
// A typecheck-only regression test in framework/tests/i18n.typecheck.test.ts
